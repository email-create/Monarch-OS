...
export default function MonarchOS() {
  ...
  const Sidebar = ({mobile}) => (
    <div style={{width:mobile?260:sW,minWidth:mobile?260:sW,background:C.bgSidebar,borderRight:`1px solid ${C.goldBorder}`,display:"flex",flexDirection:"column",height:"100vh",overflowY:"auto",position:mobile?"fixed":"sticky",top:0,zIndex:mobile?4000:10,...(mobile?{left:0}:{}),transition:"width 0.3s, min-width 0.3s"}}>
      ...
      <nav style={{flex:1,padding:"52px 0 10px",overflowY:"auto"}}>
        {NAV_ITEMS.map(n => (
  ...
  return (
    <div style={{display:"flex",minHeight:"100vh",background:C.bg,color:C.text,fontFamily:FB}}>
      ...
      {(!sidebarCollapsed||mobileNav)&&<div style={{position:"fixed",top:profile?155:100,left:16,width:mobileNav?228:sW-32,zIndex:mobileNav?4500:15,pointerEvents:"auto"}}>
