...
export default function MonarchOS() {
  ...
  const Sidebar = ({mobile}) => (
    <div style={{width:mobile?260:sW,minWidth:mobile?260:sW,background:C.bgSidebar,borderRight:`1px solid ${C.goldBorder}`,display:"flex",flexDirection:"column",height:"100vh",overflowY:"auto",position:mobile?"fixed":"sticky",top:0,zIndex:mobile?4000:10,...(mobile?{left:0}:{}),transition:"width 0.3s, min-width 0.3s"}}>
      ...
      <nav style={{flex:1,padding:"42px 0 10px",overflowY:"auto"}}>
        {NAV_ITEMS.map(n => (
        ...
        <div className="dash-two-col" style={{display:"grid",gridTemplateColumns:"1fr 340px",gap:18,alignItems:"start"}}>
          <div style={{display:"flex",flexDirection:"column",gap:18}}>
            ...
            return<Card>
              ...
              <div style={{position:"relative",width:160,height:150,margin:"12px auto 0"}}>
                <svg viewBox="0 0 100 90" style={{width:"100%",height:"100%"}}><path d="M50 85 C50 85 5 55 5 30 C5 15 18 5 32 5 C40 5 46 10 50 18 C54 10 60 5 68 5 C82 5 95 15 95 30 C95 55 50 85 50 85Z" fill={color} opacity="0.12" stroke={color} strokeWidth="1.5" opacity="0.3"/></svg>
                <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",paddingBottom:8}}>
                  <div style={{fontSize:36,fontWeight:400,color,lineHeight:1,fontFamily:FH}}>{score}</div>
                  <div style={{fontSize:9,color:C.textMuted,letterSpacing:1,textTransform:"uppercase",marginTop:4}}>Score</div>
                </div>
              </div>
            </Card>;})()}
          </div>
  ...
  return (
    <div style={{display:"flex",minHeight:"100vh",background:C.bg,color:C.text,fontFamily:FB}}>
      ...
      {!sidebarCollapsed&&<div className="m-sidebar" style={{position:"fixed",top:profile?148:96,left:16,width:sW-32,zIndex:15,pointerEvents:"auto"}}>
