...
export default function MonarchOS() {
  ...
  const CallsPage = () => {
    ...
    return(<div><TopBar title="Call Tracker"/><div style={{display:"flex",justifyContent:"flex-end",marginBottom:18}}><button style={btnStyle} onClick={()=>{setForm({leadId:"",buyerId:"",date:todayStr(),time:new Date().toLocaleTimeString("en-US",{hour12:false,hour:"2-digit",minute:"2-digit"}),result:"Answered",notes:"",followUp:"",discussed:""});setModal(true);}}>+ Log Call</button></div>
